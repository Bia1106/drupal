...
class __TwigTemplate_c9270edd629fad6b7bdc7ab03796d33c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t{{ page.content }}
\t{% endblock %}
</section>{% endblock %}{% if page.footer %}
{% block footer %}
\t<footer class=\"footer {{ container }}\" role=\"contentinfo\">
\t\t{{ page.footer }}
\t</footer>
{% endblock %}{% endif %}
", "themes/mytheme/templates/home/page--front.html.twig", "C:\\xampp\\htdocs\\drupal_project\\web\\themes\\mytheme\\templates\\home\\page--front.html.twig");
    }
