...
class __TwigTemplate_ecf26acc811fee96a4b559fe57fe8897 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% if mytheme.font_color %}
  {% set font_color = 'style=color:#' ~ mytheme.font_color %}
{% endif %}
<div class=\"component-button\">
  <a class=\"button btn {{ mytheme.model }} {{ mytheme.size }} {{ mytheme.css }}\" href=\"{{ mytheme.url }}\" {{ font_color }}>{{ mytheme.title }}</a>
</div>
", "themes/mytheme/templates/field/paragraph--button.html.twig", "C:\\xampp\\htdocs\\drupal_project\\web\\themes\\mytheme\\templates\\field\\paragraph--button.html.twig");
    }
