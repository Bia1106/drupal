...
class __TwigTemplate_cc2adc7d05bef55e8f1e19f803ce4232 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<section id=\"first-block\" class=\"container px-10\">
  <div class=\"row gx-5\">
  <div class=\"col-lg-6\">
    <div class=\"title\"><h3>";
        // line 4
    ...
    <div class=\"button wow fadeInUp\" data-wow-delay=\"1s\">";
        // line 7
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["mytheme"] ?? null), "button", [], "any", false, false, true, 7), 7, $this->source), "html", null, true);
        echo "</div>
  </div>
  <div class=\"col-lg-4\">
    <div><img src='";
        // line 10
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["mytheme"] ?? null), "image_url", [], "any", false, false, true, 10), 10, $this->source), "html", null, true);
        echo "'></div>
  </div>
  </div>
</section>
";
    ...
    {
        return array (  59 => 10,  53 => 7,  48 => 5,  44 => 4,  39 => 1,);
    }
